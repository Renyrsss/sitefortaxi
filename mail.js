...
$(function() {
  $(selector + '[action = "/"]').submit(function(e) {
    ...
    delay = 10000; // задержка исчезновения сообщения в миллисекундах (0 - не скрывать)
    success_msg = "Спасибо! Ваша заявка принята. Менеджер свяжется с Вами в ближайшее время."; // сообщение об успешной отправке
    error_msg = "Произошла ошибка. попробуйте позже"; // сообщение об ошибке
    wait_msg = '...'; // сообщение об отправке (оставить пустым чтоб не показывать)
