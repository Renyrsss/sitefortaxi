...
$email = 'Alizhan_bektassov@mail.ru'; // адрес куда отправлять письмо, можно несколько через запятую
...
$from = 'sait.robot@yandex.ru'; // имя отправителя (необязательно)
...
$username = 'sait.robot@yandex.ru'; // логин вашего почтового ящика
$password = 'mRBE4508E4Isda'; // пароль вашего почтового ящика
