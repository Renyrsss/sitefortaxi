...
Webflow.require('ix').init([
  {"slug":"close-lb","name":"Close-LB","value":{"style":{},"triggers":[{"type":"click","selector":".lb","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0"},{"display":"none"}],"stepsB":[]}]}},
  {"slug":"lb-open","name":"LB-open","value":{"style":{},"triggers":[{"type":"click","selector":".lb","stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"iphone-poyav","name":"Iphone-poyav","value":{"style":{"opacity":0,"x":"0px","y":"300px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"transition":"transform 500ms ease 0","x":"0px","y":"0px","z":"0px"},{"opacity":1,"transition":"opacity 500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"section-load","name":"Section-load","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 327ms ease 0"}],"stepsB":[]}]}}
]);
